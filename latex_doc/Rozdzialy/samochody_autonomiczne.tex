...
\source{https://www.nvidia.com/en-us/self-driving-cars/drive-platform/hardware}
...
\source{https://developer.nvidia.com/drive/drive-sdk}
...
Dodatkowo samochody Tesli są wyposażone w zestaw aktywnych funkcji bezpieczeństwa:
\vspace{-0.25cm}
\begin{enumerate*}
